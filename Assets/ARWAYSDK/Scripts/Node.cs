...
namespace Arway
{
    public class Node : MonoBehaviour
    {
        ...
        private static bool isClosestNodeSet;
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            if (!isClosestNodeSet)
            {
                Debug.Log("current closest node set");
                NotificationManager.Instance.GenerateNotification("Ready for navigation");
            }
            isClosestNodeSet = true;
        }
